...
keymap('n','<space>cse','<cmd> ChangeSurroudingEnviroment<CR>',opts)
keymap('n','<space>dse','<cmd> DeleteEnviroment<CR>',opts)
keymap('n','<space>tse','<cmd> ToggleStarEnviroment<CR>',opts)
